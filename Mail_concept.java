...
/*Mail_concept
*this class notifies the selected person 
*/
public class Mail_concept {
      final String username = "18tucs234@skct.edu.in";
        final String password = "prisonbreak";
        ResultSet rs1;
        Statement s1;
        Connection con1;
    private Component dialogbox_for_common_mail;
   public Mail_concept(String temp_name,
           String temp_mail_id,String temp_mo,
           String temp_loc,String temp_date,String temp_rollno){
       try{
            Class.forName("com.mysql.jdbc.Driver");
            Connection con1=DriverManager.getConnection("jdbc:mysql://localhost/bootcamp"
